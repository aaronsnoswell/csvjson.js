...
var csvjson={};
(function(){function j(c){if(typeof c=="undefined")return!1;return!0}csvjson.csv2json=function(c,b){var b=b||{},h=j(b.delim)?b.delim:",",e=j(b.textdelim)?b.textdelim:"",a=c.split("\n"),f=a[0].replace(RegExp(e,"g"),"").split(h),a=a.slice(1,a.length),d={};d.headers=f;d.rows=[];for(var k in a){var i=a[k].split(h),m={},l;for(l in i){var g=i[l];e.length!==0&&(g=g.replace(RegExp(e,"g"),""));!isNaN(g*1)&&(g=g*1);m[f[l]]=g}d.rows.push(m)}return d};csvjson.json2csv=function(c,
